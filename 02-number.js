...
let n2 = Number(2024);    // Number 객체를 이용해 입력
console.log(n1,n2);
console.log(typeof n1, typeof n2); // Number

// 수치 데이터 입력하는 방법
const hex = 0xFF0000; // 16진수 -> ex
...
console.log(Math.min(1,5,3,2,6,7), Math.max(1,5,3,2,6,8));  // 최소값, 최댓값
...
console.log(parseInt("123.456"));   // 123.456 -> 정수형 123 분석
console.log(parseFloat("123.456")); // 123.456 -> 실수형 123 분석
